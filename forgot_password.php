...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script type="text/javascript">
        ...
        <title>Working Capital Enhancement Forgot Password</title>
                                          ...
                                          <div style="float: none; margin-top: 74px; width: 100%;">
											<?php //user_not_available error
											   ...
											   if ($_GET['msg'] == "no_entry") {
												...
												else if ($_GET['msg'] == "date_of_birth_not_matched") {
													echo "Please Enter correct Date of Birth!";
												}
												else if ($_GET['msg'] == "user_not_available") {
													echo "User Not Available for this KOID!";
												} 	
                                        ...
                                        <td  valign="top">
										  <table width="93%" border="0" cellspacing="3" cellpadding="3"  align="center" />
										   ...
										   <fieldset id="fieldset3" class="fieldset">
											<legend class="form_legend_heading_maroon">Forgot Password</legend>
                                            <table width="50%" border="0" cellspacing="3" cellpadding="3"  align="center"  class="data" />
											<form id="myForm" method="POST" action="password_change_process.php" onsubmit="return formValidator();">
											   <tr>
												   <td></td>
												   <td>
